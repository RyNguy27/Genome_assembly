...
INDIR=/scratch/rnguyen/genome_assembly/results/04_assembly/scaffoldedAssemblies/
CONTIGDIR=/scratch/rnguyen/genome_assembly/results/04_assembly/hifiasm_fastas/
OUTDIR=/scratch/rnguyen/genome_assembly/results/05_assemblyQC/contactMaps
mkdir -p ${OUTDIR}
...
FAI=${CONTIGDIR}/Aphoeniceus_hap${hap}.fa.fai
