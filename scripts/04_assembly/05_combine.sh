...
#input/output
INDIR=/scratch/rnguyen/genome_assembly/results/04_assembly/HiC_align
FAIDX=/scratch/rnguyen/genome_assembly/results/04_assembly/hifiasm_fastas/Aphoeniceus_${hap}.fa.fai
