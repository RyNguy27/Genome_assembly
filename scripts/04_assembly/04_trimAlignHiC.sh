...
OUTDIR=/scratch/rnguyen/genome_assembly/results/04_assembly/HiC_align
mkdir -p ${OUTDIR}

# genome index
INDEX=/scratch/rnguyen/genome_assembly/results/04_assembly/hifiasm_fastas/${hap}_index/${hap}

# fastq to align
FQ=${INDIR}/bAgePho1_S5_${rn}_001.fastq.gz

# set read group variable
RG=$(echo \@RG\\tID:Aphoeniceus\\tSM:Aphoeniceus\\tLB:Aphoeniceus\\tPL:ILLUMINA\\tPU:none)
